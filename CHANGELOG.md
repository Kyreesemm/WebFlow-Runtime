...
### Changed
- Minor edit of the Gemini name in neural network templates

---

## [v0.2.3-dev] - September 2nd, 2026
...
- AI templates now select the platform-specific Google Chrome User-Agent automatically.
- Added smooth closing animations to all manager modal windows.
...
### Added
- Bundled Roboto and Material Symbols Rounded fonts for offline manager operation.
- Added reliable embedded WebView serving for the bundled manager fonts.
